...
public class VerificationCodeImage {
    ...
    private int fontBasicSize = 24;
    private int fontSizeRange = 5;
    ...
    /**
     * @param textLength 验证码字符串长度
     * @param codes      一个字符数组，生成的验证码中的字符从该字符在数组中获取,字符必须为英文状态下的字符,null使用默认值
     */
    ...
    public VerificationCodeImage(int w, int h, int textLength, String codes) {
        this(w, h, textLength, 24, 5, null, codes);
    }
    ...
    public VerificationCodeImage(int w, int h, int textLength,
        ...
        this(w, h, textLength, fontBasicSize, fontSizeRange, null, null);
    }
     ...
     * @param fontBasicSize 字体大小的最低值
     * @param fontSizeRange 字体大小的浮动范围
     * @param fontNames     指定验证码中字符字体类型，由字符类型名称组成的一个字符串数组,null使用默认值
     * @param codes         一个字符数组，生成的验证码中的字符从该字符在数组中获取,字符必须为英文状态下的字符,null使用默认值
     */
    public VerificationCodeImage(int w, int h, int textLength,
